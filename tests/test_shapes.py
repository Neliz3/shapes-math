...
class TestSquare:
    ...
    def test_perimeter(self, topRight, side, expected):
        assert Square(topRight, side).get_perimeter() == expected
    ...
    def test_area(self, topRight, side, expected):
        assert Square(topRight, side).get_area() == expected
...
class TestRectangle:
    ...
    def test_perimeter(self, topRight, bottomLeft, expected):
        assert Rectangle(topRight, bottomLeft).get_perimeter() == expected
    ...
    def test_area(self, topRight, bottomLeft, expected):
        assert Rectangle(topRight, bottomLeft).get_area() == expected
...
class TestCircle:
    ...
    def test_perimeter(self, center, radius, expected):
        assert Circle(center, radius).get_perimeter() == expected
    ...
    def test_area(self, center, radius, expected):
        assert Circle(center, radius).get_area() == expected
...
class TestTriangle:
    ...
    def test_perimeter(self, point1, point2, point3, expected):
        assert Triangle(point1, point2, point3).get_perimeter() == expected
    ...
    def test_area(self, point1, point2, point3, expected):
        assert Triangle(point1, point2, point3).get_area() == expected
